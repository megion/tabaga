 ...
 */
tabaga.DragScrollContainer = function(container) {
	this.rememberBound = null;
	this.managedContainer = container;
}

tabaga.DragScrollContainer.prototype.onDragStart = function() {
...
tabaga.DragScrollContainer.prototype.onDragMove = function(x, y) {
